...
```{r}
## pdflatex not found on oaxaca/Mac OS X
Sys.setenv(PATH=paste(Sys.getenv("PATH"),"/usr/texbin",sep=":"))

## Data from normal tissue
object<- CopyNumber450kData::RGcontrolSetEx
dataset <-  minfi::RGChannelSet(
    Green=BiocGenerics::getObjectSlots(object)[["assayData"]][["Green"]],
    Red=BiocGenerics::getObjectSlots(object)[["assayData"]][["Red"]],
    colData = BiocGenerics::getObjectSlots(
        BiocGenerics::getObjectSlots(object)[["phenoData"]])[["data"]],
    annotation = BiocGenerics::getObjectSlots(object)[["annotation"]]
)
