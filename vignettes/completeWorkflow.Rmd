...
dataset <- CopyNumber450kData::RGcontrolSetEx
slot(dataset, "colData", check=FALSE) <- colnames(Biobase::pData(dataset))
slot(dataset, "rowData", check=FALSE) <- rownames(Biobase::pData(dataset))
